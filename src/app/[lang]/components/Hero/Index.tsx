...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-6xl font-bold mb-4 flex items-center gap-5 flex-wrap">
          <motion.span
        ...
        <motion.div
          className={cn(
            ...
            hoverItem !== 'subtitle' && 'w-full lg:w-[40vw]'
          )}
          initial={{ opacity: 0, x: -50, filter: 'blur(10px)' }}
          animate={{
            opacity: 1,
      ...
      >
        ...
        >
          ...
          <motion.span
            className="bg-white/80 rounded px-4 py-2 font-mono text-lg text-black shadow-lg select-none"
            animate={{
              backgroundColor: [
        ...
        >
          ...
          <motion.span
            className="ml-2 bg-white/70 rounded px-2 py-1 font-mono text-base text-purple-700 shadow select-none"
            animate={{
              scale: [1, 1.1, 1],
              backgroundColor: [
        ...
        <motion.div
          className="absolute top-2/3 left-1/3 -translate-y-1/2 flex items-center"
          animate={{
            rotate: [0, 3, -3, 0],
            y: [0, -12, 0]
          }}
